...
void printTTT() {
	...
	cout << vert << "   " << under << ttt.pos[0] << vert << 'X' << vert << ttt.pos[2] << _under << endl;
	cout << vert << "   " << under << ttt.pos[3] << vert << ttt.pos[4] << vert << ttt.pos[5] << _under << endl;
	cout << vert << "   " << ttt.pos[6] << vert << ttt.pos[7] << vert << ttt.pos[8] << endl;
	cout << under << vert <<"             "<<vert<<_ endl;
}
